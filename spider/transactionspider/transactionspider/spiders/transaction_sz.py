...
class TransactionSzSpider(scrapy.Spider):
    name = 'transaction_sz'
    ...
    def start_requests(self):
        url_list = []
        current_index = 10
        microdistrict_list = open('H:/codes/graduateProject/data/source/microdistrict/sz/microdistrict_sz_' + str(current_index) + '.txt','r').readlines()
        for microdistrict in microdistrict_list:
            url = 'https://sz.lianjia.com/chengjiao/rs' + microdistrict + '/'
